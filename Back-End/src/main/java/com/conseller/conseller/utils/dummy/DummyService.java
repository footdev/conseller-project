...
public class DummyService {
    ...
    public void createDummyGifticonsAndSaveAll() {
        ...
        "카페 모카 T", "피치 요거트 블렌디드 T", "디카페인 카페 아메리카노 T", "아이스 디카페인 카페 아메리카노 T", "망고 패션 블렌디드 T", "바닐라 카페라떼 (R)", "로얄 밀크티 쉐이크"},
                {"순두부 찌개", "백반 정식", "김밥 + 라면 정식", "제육 덮밥", "오징어 덮밥", "김치 라면", "불고기 정식", "된장찌개", "김치찌개", "고추장 찌개",
                "두찜 한마리반 이용권", "불낙죽 (순한맛)", "소고기무국", "닭볶음탕", "족발 大", "국물 떡볶이 + 순대 2인분", "기본 김밥", "참치 김밥", "스팸 볶음밥",
                "1인 보쌈 실속세트", "외식교환권 1만원권", "외식 교환권 3만원권", "로제 떡볶이"}
        };
