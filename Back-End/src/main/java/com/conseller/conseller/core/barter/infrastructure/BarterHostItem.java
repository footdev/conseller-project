...
public class BarterHostItem {
    ...
    @Builder
    public BarterHostItem(BarterEntity barterEntity, GifticonEntity gifticonEntity) {
    ...
    public BarterHostItemDto toBarterHostItemDto(BarterHostItem barterHostItem) {
        GifticonEntity gifticonEntity = barterHostItem.getGifticonEntity();
        ...
        return BarterHostItemDto.builder()
                .barterIdx(barterHostItem.getBarterEntity().getBarterIdx())
